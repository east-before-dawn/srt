...
/**
 * The <code>photo_featureRemote</code> class provides a Java RMI-compliant interface to 
 ...
 * <code>photo_featureRemote</code> instance when it is no longer needed to ensure that 
 ...
 * generate RMI server proxy objects for instances of srt.photo_feature.
 */
public interface photo_featureRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>color_f</code> M-function 
     ...
     */
    public Object[] color_f(int nargout, Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] face_detection(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>texture_f</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] texture_f(int nargout, Object... rhs) throws RemoteException;
